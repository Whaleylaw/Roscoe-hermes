...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("peer-watch", "Receive peer-team messages in this open CLI session", "Session",
               aliases=("peerwatch",), cli_only=True,
               args_hint="[start|stop|status] [--agent id] [--project name] [--team id]",
